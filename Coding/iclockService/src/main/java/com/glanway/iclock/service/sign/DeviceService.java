...
public interface DeviceService extends BaseService<Device>{
	 ...
	 * 
	 * 说明 : 
	 * 根据设备sn 查询 需要到当前设备上打卡的所有员工指纹模板或脸部模板
	 * @param sn 设备代码
	 * @param type 类型 1.指纹模板 2.面部模板
	 * @return
	 * @author zhangshaung
