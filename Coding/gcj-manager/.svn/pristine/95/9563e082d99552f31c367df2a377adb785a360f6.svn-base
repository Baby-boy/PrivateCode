...
public class BasePing {
	 ...
	 */
	final static String apiKey = "sk_live_KiHGyD4mf980LKanP0S8eXPG";
	 ...
	 */
	final static String appId = "app_PiHajDrL4GeLLOOG";
	...
	// 成功回调地址
	static String alipayWapSuccessUrl;

	@Value("${privateKeyFilePath}")
	public void setPrivateKeyFilePath(String privateKeyFilePath) {
		BasePing.privateKeyFilePath = privateKeyFilePath;
		System.out.println("私钥: " + privateKeyFilePath);
	}

	@Value("${pingpp.alipayWapSuccessUrl}")
	public static void setAlipayWapSuccessUrl(String alipayWapSuccessUrl) {
		BasePing.alipayWapSuccessUrl = alipayWapSuccessUrl;
		System.out.println("成功回调地址: " + alipayWapSuccessUrl);
	}
