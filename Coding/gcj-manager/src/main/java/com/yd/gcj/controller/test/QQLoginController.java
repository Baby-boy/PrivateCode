package com.yd.gcj.controller.test;
...
import com.yd.gcj.util.GsonUtil;
import com.yd.gcj.util.UUIDUtil;
...
public class QQLoginController {
	...
	private static final String REDIRECT_URL = "http://gcj.excelsiorbrand.cn/user/userThirdLogin";// TODO 回调地址需要修改
	...
	public String jump(@RequestParam(value = "code", required = false) String code, 
		...
		if (null == code) {
			...
			if (!state.equals(request.getSession().getAttribute("qq_state"))) {
				return "redirect:http://gcj.excelsiorbrand.cn";// TODO 这里的跳转需要修改
			}
