...
@param {Object} settings For detailed information about each option check documentation.
	...
	@param {Number|String} [settings.max_file_size] Maximum file size that the member can pick, in bytes. Optionally supports b, kb, mb, gb, tb suffixes. `e.g. "10mb" or "1gb"`. By default - not set. Dispatches `plupload.FILE_SIZE_ERROR`.
