...
jQuery.fn.searchFilter.defaults = {
    ...
    /*
     * FUNCTION
     * DESCRIPTION: the function that will be called when the member clicks Reset
    ...
    /*
     * FUNCTION
     * DESCRIPTION: the function that will be called when the member clicks Search
     * INPUT TYPE:  JS object if stringResult is false, otherwise is JSON string
     */
    ...
    /*
     * FUNCTION
     * DESCRIPTION: the function that will be called when the member clicks the Closer icon
